...
export const metaUpgradeCatalog: readonly MetaUpgrade[] = [
  ...
  },
  {
    ...
    requirement: "available",
    tag: "cannon",
    technologyId: "velocity-tuner",
    upgradeId: "velocity-tuner",
  ...
  },
  {
    ...
    kind: "card",
    name: "Carte chassis",
    description: "Débloque Technologie chassis et ses tiers supérieurs.",
    maxLevel: 4,
    costAt: costFrom(CARD_COSTS),
    requirement: "clear-stage-1",
    tag: "salvage",
    technologyId: "vital-frame",
    upgradeId: "vital-frame",
    levels: cardLevels("Technologie chassis"),
  },
  {
    id: "card:thermal-vampire",
    kind: "card",
    name: "Carte hémo",
    description: "Débloque Technologie hémo et ses tiers supérieurs.",
    maxLevel: 4,
    costAt: costFrom(CARD_COSTS),
    requirement: "boss-kill",
    tag: "salvage",
    technologyId: "thermal-vampire",
    upgradeId: "thermal-vampire",
    levels: cardLevels("Technologie hémo"),
  },
  {
