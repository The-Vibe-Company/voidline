...
cd "$SIM_DIR"
# Cargo cache invalidation marker — bump when shared source changes in a way
# that mtime-based fingerprinting can miss on Modal's persistent cache volume.
REBUILD_MARKER_VALUE="20260501d-oracle-rl-foundation"
